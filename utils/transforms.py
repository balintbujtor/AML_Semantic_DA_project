...
img_std_transformations = {
    "std_cityscapes" : v2.Compose([v2.Resize((512, 1024), Image.BILINEAR),v2.ToTensor(),v2.Normalize(mean=MEAN, std=STD)]),
    "std_gta5" : v2.Compose([v2.Resize((526,957), Image.BILINEAR),v2.ToTensor(),v2.Normalize(mean=MEAN, std=STD)])
}
